...
<img src="IMG/delivery.png" id="estado_pedidos" class="key" key="0" title="Click para consultar pedidos" /> 

<img src="IMG/pizza.png" id="cambiar_vista" class="key" key="86" title="Click para agregar Productos"/>


<div id="vista_pedidos" style="width:80%;padding-top: 10px;position:relative;">
    <div id="botones_principales">        
        <button class="key" key="69" id="enviar_orden_a_cocina" style="font-weight: bold;height:30px;margin-bottom:1px;">Enviar Orden</button><br />
    ...
    <div id="vista_cliente">
        <div id="datos_cliente" >
            <div style="margin:5px 15px;padding:5px;border:3px solid black;border-radius: 10px;">
                <h1> INFORMACION DE CLIENTES </h1><br/>
                <p style="margin-left:25px;">
                    ...
                    <button class="rsv" id="guardar_datos">Guardar Cliente</button><br />
                ...
                <p style="margin-left:10px;">
                    <input type="checkbox" id="flag_pausa" name="pedido_pausar_orden" value="1">
                    <label for="flag_pausa">Pausar orden y mostrarla hasta:</label>
        ...
        <div id="datos_pago" >
            <div style="margin:5px 15px;padding:5px;border:3px solid black;border-radius: 10px;">
                ...
                <p id="metodo_pago_efectivo" style="margin-left:25px;margin-top:0px;display:none;">
                    <label class="forma" for="cliente_vuelto">Cambio para $:</label>
                    <input type="text" id="cliente_vuelto" placeholder="0.00" value="" style="width:100px;" /><br />
                </p>
 ...
 <div id="vista_pizza" style="display: none;">
    ...
    <tr>
        <?php
            ...
            $c = "SELECT catalogo_id, catitem FROM catalogo WHERE active='1' "
                    . "AND catname='menu' ORDER BY catitem";
        ...
        <?php } ?>
        <td><a class="mp key" rel="99" key="99" href="#">RESET</a></td>
    </tr>
</table>
    </div>
</div>
