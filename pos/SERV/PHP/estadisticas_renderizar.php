...
function estadisticas_renderizar($datos) {
    ...
    if (!empty($datos['aux']['venta_por_horas'])) {
        ...
        estadisticas_agregar_panel('Distribucion de ventas por hora', '<ul>' . $buffer . '</ul>');
    } else {
    ...
    if (!empty($datos['aux']['venta_por_dias'])) {
        ...
        estadisticas_agregar_panel('Total de ventas por dia', '<ul>' . $buffer . '</ul>');
    } else {
        estadisticas_agregar_info('Sin datos de rendimiento de ventas por dia');
    }
    ...
    if (!empty($datos['aux']['pizzas_por_dia'])) {
        ...
        estadisticas_agregar_panel('Platos vendidos por dia', '<ul>' . $buffer . '</ul>');
    } else {
        estadisticas_agregar_info('Sin datos de rendimiento de venta de platos por dia');
    }
    ...
    estadisticas_agregar_info('Tiempo maximo de despacho: ' . $datos['aux']['tms'] . '<br><br>');
