...
. 'cue.flag_anulado = 0 AND ped.flag_cancelado = 0 and cue.ID_mesero=' .$idmesero 
...
echo 'go it: ' . $periodo_inicio  . ' -- ' . $periodo_final . ' . ' . $indivPerformanceReportUsr;
?>
